...
import { Sparkles, ArrowRight, Shield, Zap, Users, Loader2 } from "lucide-react";
      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="glass rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">
              {isLogin
                ...
                : "Comece sua jornada com a Restech AI"}
            </p>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="btn btn-google w-full py-4 text-base mb-6 group disabled:opacity-50"
          >
            {loading ? (
        ...
        <p className="text-center mt-8 text-sm text-slate-500">
          Ao {isLogin ? "fazer login" : "cadastrar"}, você concorda com nossos{" "}
          <Link
            href="/termos"
